...
public class Board implements Serializable { // TODO: parcelable in the future
  ...
  public static void load() {
    ...
    if (json != null)
      savedBoards = gson.fromJson(
          json, new TypeToken<HashMap<Integer, Board>>() {}.getType());
    else
      savedBoards = new HashMap<>();
  ...
  public byte getRearAngle() { return rearAngle; }

  public void setRearAngle(byte rearAngle) { this.rearAngle = rearAngle; }

  public byte getFrontAngle() { return frontAngle; }

  public void setFrontAngle(byte frontAngle) { this.frontAngle = frontAngle; }
