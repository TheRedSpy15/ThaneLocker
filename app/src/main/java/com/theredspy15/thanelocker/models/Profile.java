...
public class Profile implements Serializable {
  ...
  public Profile() {
    ...
    // if (!savedSessionIds.contains(randId)) setId(randId); TODO: check with
    // database when thats created else while (savedSessionIds.contains(randId))
  ...
  public static ArrayList<Session>
  sessionsWithLocalProfile() { // TODO: overload later on to loading from
                               // database when thats created
  ...
  boardsWithLocalProfile() { // TODO: overload later on to loading from database
                             // when thats created
  ...
  public ArrayList<Integer> getFriend_ids() { return friend_ids; }
