...
public class App extends Application {
  ...
  private static Context mContext; // TODO: find an alternative to this. doesn't
                                   // seem to cause leak using profiler however

  public static Context getContext() { return mContext; }

  public static void setContext(Context mContext) { App.mContext = mContext; }
  ...
  public static void cleanBoards() { // TODO: clean hashmap, duplicates
    ...
    for (int id : list)
      Board.savedBoardIds.remove((Integer)id);
  }
  ...
  public static void cleanSessions() { // TODO: clean hashmap, duplicates
    ...
    for (int id : list)
      Session.savedSessionIds.remove((Integer)id);
  }
  ...
  public static LineData createLineSet(ArrayList<Entry> values, String label,
                                       Context context) {
    LineDataSet set;
  ...
  /**
   * returns a speed as a string for display in activity with correct unit of
   * measurement
  ...
  /**
   * returns a distance as a string for display in activity with correct unit of
   * measurement
   * @param distance should already be in miles
   * @return
   */
  public static String getDistanceFormatted(float distance,
                                            Resources resources) {
