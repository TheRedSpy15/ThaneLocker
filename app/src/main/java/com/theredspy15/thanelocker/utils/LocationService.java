...
public class LocationService extends Service {
  ...
  private void createNotificationChannel() {
    if (Build.VERSION.SDK_INT >=
        Build.VERSION_CODES.O) { // TODO: add support for older versions
  ...
  // already checked on button press before this can get called
  void startTracker() {
    ...
    locationManager.requestLocationUpdates(
        ...
        MainActivity.preferences.getInt("pollrate", 2500), 1, locationListener);
  }
