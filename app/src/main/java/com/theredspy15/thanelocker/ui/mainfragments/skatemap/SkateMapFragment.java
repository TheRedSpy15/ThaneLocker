...
public class SkateMapFragment extends Fragment {
    ...
    private void resetCreatingMeetup() {
        ...
        binding.button.setBackgroundColor(requireContext().getColor(R.color.purple_500));
        binding.button.setOnClickListener(this::createMeetup);
    ...
    public final void createMeetup(View view) {
        ...
        binding.button.setBackgroundColor(getContext().getColor(R.color.recording_session));
    ...
    public View.OnClickListener confirmedLocation() {
        ...
        new AlertDialog.Builder(requireContext())
                ...
                .setPositiveButton("Next", (dialog, whichButton) -> {
                    ...
                    newMeetup.setMeet_id((int) (newMeetup.getLatitude()+ newMeetup.getLongitude()));

                    new AlertDialog.Builder(requireContext())
                            .setTitle("Select Date")
                            .setView(datePicker)
                            .setPositiveButton("Create",(dialog2,whichButton2) -> {
                                newMeetup.setDate(datePicker.getMonth() + "/" + datePicker.getDayOfMonth());
                                Meetup.uploadMeetup(newMeetup);
                                dialog.dismiss();
                            })
                            .setNegativeButton(R.string.cancel, (dialog2, whichButton2) -> resetCreatingMeetup()).show();
                })
                .setNegativeButton(R.string.cancel, (dialog, whichButton) -> resetCreatingMeetup()).show();
        return null;
    }
    ...
    Overlay touchOverlay = new Overlay(){
        ...
        public boolean onSingleTapConfirmed(final MotionEvent e, final MapView mapView) {
            final Drawable marker = requireContext().getDrawable(R.drawable.ic_baseline_location_on_24);
