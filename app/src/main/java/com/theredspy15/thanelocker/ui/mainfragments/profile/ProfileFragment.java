...
public class ProfileFragment extends Fragment {
  ...
  private void loadAllData() { // TODO: multi-thread this
    if (Profile.localProfile.getName() != null)
      binding.nameText.setText(Profile.localProfile.getName());
    if (Profile.localProfile.getDescription() != null)
  ...
  private void loadDistancesChart() {
    ...
    // create a data object with the data sets
    LineData data = App.createLineSet(values, getString(R.string.distances),
                                      requireContext());
  ...
  private void loadDurationsChart() {
    ...
    // create a data object with the data sets
    LineData data = App.createLineSet(values, getString(R.string.durations),
                                      requireContext());
